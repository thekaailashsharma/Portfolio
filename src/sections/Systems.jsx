...
const systems = [
  ...
  },
  {
    ...
    impact: 'Featured on Google Play Academy blog. #AndroidSpotlight by Android Developers (Google). Special Recognition at HackOdisha 3.0 (NIT Rourkela).',
  ...
  return (
    <section id="systems" className="relative px-6 sm:px-10 lg:px-20 py-28 sm:py-36">
      ...
      <div className="relative max-w-6xl mx-auto">
        <SectionLabel label="Systems I Built" number="04" />
            ...
            return (
              <FadeIn key={system.id} delay={i * 0.08} y={16}>
                <motion.div
                  ...
                  className={`group cursor-pointer rounded-xl border overflow-hidden transition-all duration-500 h-full ${
                    isActive
                      ? 'bg-surface-2/80 border-accent/15 dark:shadow-2xl dark:shadow-black/30 shadow-lg shadow-stone-200/30'
                      : 'bg-surface-1/30 border-surface-3/40 hover:bg-surface-1/60 hover:border-surface-4/60'
                  }`}
                  layout
                >
                      ...
                      {isActive && (
                        ...
                        >
                          <motion.div
                            ...
                            className="mb-4"
                          >
                            <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-accent/40 block mb-1.5">
                              Solution
                            </span>
                            <p className="font-sans text-[13px] dark:text-zinc-400 text-stone-500 leading-relaxed">
                              {system.solution}
                            </p>
                          </motion.div>
                          ...
                          <motion.div
                            ...
                            className="mb-4"
                          >
                            <span className="font-mono text-[9px] uppercase tracking-[0.2em] dark:text-emerald-400/40 text-emerald-600/50 block mb-1.5">
                              Impact
                            </span>
                          ...
                          <motion.div
                            ...
                            className="mb-5 p-3.5 rounded-lg bg-surface-3/30 border-l-2 border-accent/15"
                          >
                            <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-accent/35 block mb-1.5">
                              Key Learning
                            </span>
                            <p className="font-sans text-[13px] dark:text-zinc-400 text-stone-500 leading-relaxed italic">
                              {system.learning}
                            </p>
                          </motion.div>
                          ...
                          >
                            {system.stack.map((tech) => (
                              <span key={tech} className="font-mono text-[9px] px-2 py-0.5 rounded-md bg-surface-3/50 dark:text-zinc-500 text-stone-400 tracking-wider">
                                {tech}
                              </span>
                            ))}
                          </motion.div>
